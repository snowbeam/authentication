...
import { ERROR_RESPONSES } from 'helpers/constants';
...
/* The AuthError class is a subclass of the Error class in TypeScript that represents an authentication
error and includes additional properties for the error body and code. */
...
export function getRequestOptions(
  { url, method, body, query, headers }: ClientOAuth2RequestObj,
